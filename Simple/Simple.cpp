...
BEGIN_MESSAGE_MAP(CSimpleApp, CWinApp)
	...
	ON_COMMAND(ID_FILE_NEW, &CSimpleApp::OnFileNew)
END_MESSAGE_MAP()
...
BOOL CSimpleApp::InitInstance()
{
	...
	m_hMDIMenu  = ::LoadMenu(hInst, MAKEINTRESOURCE(IDR_SimpleTYPE));
	m_hMDIAccel = ::LoadAccelerators(hInst, MAKEINTRESOURCE(IDR_SimpleTYPE));
...
void CSimpleApp::OnFileNew()
{
	CMainFrame* pFrame = STATIC_DOWNCAST(CMainFrame, m_pMainWnd);
	// 새 MDI 자식 창을 만듭니다.
	pFrame->CreateNewChild(
		RUNTIME_CLASS(CChildFrame), IDR_SimpleTYPE, m_hMDIMenu, m_hMDIAccel);
}
